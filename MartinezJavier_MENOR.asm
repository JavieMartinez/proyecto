# Numero menor entre N numeros
# Descripción: Pediremos entre 3 y 5 numeros de los cuales mostraremos el menor 
...
main:
  ...
  # Inicializamos contador y minimo 
  li $t1, 0
  li $t2, 2147483647   # valor maximo posible (para buscar el menor)
...
loop:
   ...
   # Comparamos con minimo 
   bge $t3, $t2, no_cambia
   move $t2, $t3        # Actualizamos minimo 
